...
<head>
  ...
  <title>Sombrillas | Mr.Persianas</title>
  <!-- plugins:css -->
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2>Bienvenidos al dashboard de Sombrillas</h2>
                    <p class="mb-md-0">Administración de información del apartador de sombrillas.</p>
                  </div>
                </div>
