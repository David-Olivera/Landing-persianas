<?php
	...
	$sql="SELECT * FROM productos WHERE tipo_produ = 'Enrrollables Dobles' or tipo_produ = 'Enrrollables Traslucidas' or tipo_produ = 'Enrrollables Black Out';";
?>
                                ...
                                <form action="../../controller/agregar_persiana.php" method="POST" name="frmnoticia" enctype="multipart/form-data">
                                      ...
                                      <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <select class="form-control " name="tipo" id="exampleFormControlSelect1" autofocus required>
                                          ...
                                          <option value="Enrrollables Dobles">Enrrollables Dobles</option>
                                          <option value="Enrrollables Traslucidas">Enrrollables Traslucidas</option>
                                          <option value="Enrrollables Black Out">Enrrollables Black Out</option>
                                        </select>
                                      </div>
