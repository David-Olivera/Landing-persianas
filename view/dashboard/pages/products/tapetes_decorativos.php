<?php
	...
	$sql="select * from productos where tipo_produ = 'tapetes';";
?>
...
<head>
  ...
  <title>Tapetes Decorativos | Mr.Persianas</title>
  <!-- plugins:css -->
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2>Bienvenidos al dashboard de Tapetes Decorativos</h2>
                    <p class="mb-md-0">Administración de información del apartador de tapetes decorativos.</p>
                  </div>
                </div>
                    ...
                    <div class="modal-content">
                      ...
                      <!-- Modal body -->
                        ...
                        <div class="modal-body">
                                <form action="../../controller/agregar_tapete.php" method="POST" name="frmnoticia" enctype="multipart/form-data">
                                      ...
                                      <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input id="" type="hidden"class="form-control" placeholder="Tipo" value="tapetes"  name="tipo"  required>
                                      </div>
                    ...
                    <table id="recent-purchases-listing" class="table text-center">
                      ...
                      function eliminar(articulo){
                        if(confirm("Estas seguro de eliminar el articulo")){
                          location.href="../../controller/eliminar_tapete.php?id="+articulo;
                        };
                      }
                    </script>
                      ...
                      foreach($resultado as $datos){
                        ...
                        echo<<<HTML
                        <tr>
                           <td><img src="../../img/productos/tapetes/$ImgActual"/></td>
                          <td>$fechaActual</td>
